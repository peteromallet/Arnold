...
API_WORKFLOW = {'9': {'class_type': 'SaveImage', 'inputs': {'widget_0': 'Flux2-Klein-4b-base', 'images': ['75', 0]}},
 '76': {'class_type': 'LoadImage', 'inputs': {'widget_0': 'robed_women.png', 'widget_1': 'image'}},
 '94': {'class_type': 'SaveImage', 'inputs': {'widget_0': 'Flux2-Klein-4b-base', 'images': ['92', 0]}},
 '81': {'class_type': 'LoadImage', 'inputs': {'widget_0': 'pink_tone_chair.png', 'widget_1': 'image'}},
...
READY_METADATA = {'model_assets': [{'name': 'flux-2-klein-base-4b-fp8.safetensors',
                  ...
                  {'name': 'full_encoder_small_decoder.safetensors',
                   ...
                   'subdir': 'vae'}],
 'unbound_inputs': {'seed': 4001},
 'ready_template': 'edit/flux2_klein_4b_image_edit_base',
 'workflow_template': 'flux2_klein_4b_image_edit_base',
 'capability': 'image_edit',
 'source_role': 'materialized_ready_python_template',
 'source_workflow': 'workflow_corpus/official/edit/flux2_klein_4b_image_edit_base.json',
 'coverage_tier': 'supplemental',
 'approach': 'official Flux.2 Klein 4B base image-edit workflow',
 'runtime_note': None,
 'discord_signal': None}

READY_REQUIREMENTS = {'models': [{'name': 'flux-2-klein-base-4b-fp8.safetensors',
             'url': 'https://huggingface.co/black-forest-labs/FLUX.2-klein-base-4b-fp8/resolve/main/flux-2-klein-base-4b-fp8.safetensors',
             'subdir': 'diffusion_models'},
            {'name': 'qwen_3_4b.safetensors',
             'url': 'https://huggingface.co/Comfy-Org/z_image_turbo/resolve/main/split_files/text_encoders/qwen_3_4b.safetensors',
...
def build():
    return build_api_ready_workflow(
        ...
        workflow_id=READY_METADATA.get("ready_template", "edit/flux2_klein_4b_image_edit_base"),
