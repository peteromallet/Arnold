...
def PUBLIC_INPUTS(**nodes):
    image = nodes['image']
    return {
    'image': InputSpec(node=image, field='image', default='image_qwen_image_edit_input_image.png', type='IMAGE', required=True, aliases=('input_image',), media_semantics='image'),
    }

READY_METADATA = ReadyMetadata.build(
    capability='unknown',
    inputs=PUBLIC_INPUT_METADATA,
    provenance={'source_path': 'workflow_corpus/official/edit/qwen_image_edit.json', 'source_id': 'qwen_image_edit', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/official/edit/qwen_image_edit.json', 'source_hash': 'sha256:34d4a94e9a60c9e60ccd96b965834eee92d0428288cbe000cea6837d9b2f9a94', 'output_mode': 'ready_template', 'ready_id': 'edit/qwen_image_edit'},
)
...
def qwen_image_edit(
    *,
    ...
    # vibecomfy source hash: sha256:fbd5c52336fb389bc6b0f9544c5c721f888a393d16c0fbc9fc5991215c96c8ac
...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        saveimage = SaveImage(images=qwen_image_edit)

        return wf.finalize(PUBLIC_INPUTS(**locals()), output_type='SaveImage', name='image', artifact_kind='image', mime_type='image/png', expected_cardinality='one', filename_prefix='ComfyUI')
