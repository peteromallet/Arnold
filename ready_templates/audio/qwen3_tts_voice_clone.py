...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/qwen_tts/1038lab/qwen3_tts_voice_clone.json', 'source_id': 'qwen3_tts_voice_clone', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/qwen_tts/1038lab/qwen3_tts_voice_clone.json', 'output_mode': 'ready_template', 'ready_id': 'audio/qwen3_tts_voice_clone'},
)
