...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan21_14b_flf2v.json', 'source_id': 'wan21_14b_flf2v', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan21_14b_flf2v.json', 'source_hash': 'sha256:6a7b43e9091d9ba19b07f8e200d6d217d5b3ed8faa3353089d1ca4620fceff7d', 'output_mode': 'ready_template', 'ready_id': 'video/wanvideo_wrapper_21_14b_flf2v'},
)
...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        image_image, width_image, height_image, mask_image = ImageResizeKJv2(
            ...
            divisible_by=16,
            device=DEVICE,
            unused_widget_8=UNUSED_WIDGET_8,
            image=image_load,
        )
        ...
        return wf.finalize(PUBLIC_INPUTS(**locals()), output_type='VHS_VideoCombine', name='video', artifact_kind='video', mime_type='video/mp4', expected_cardinality='one', filename_prefix='WanVideoWrapper_I2V_endframe')
