...
def build() -> VibeWorkflow:
    ...
    vhs_videocombine = VHS_VideoCombine(
        ...
        save_metadata=True,
        trim_to_audio=False,
        videopreview={'hidden': False, 'paused': False, 'params': {'filename': 'WanVideoWrapper_5BI2V_00004.mp4', 'subfolder': '', 'type': 'temp', 'format': 'video/h264-mp4', 'frame_rate': 24, 'workflow': 'WanVideoWrapper_5BI2V_00004.png', 'fullpath': '/home/user/Projects/ComfyUI/temp/WanVideoWrapper_5BI2V_00004.mp4'}},
