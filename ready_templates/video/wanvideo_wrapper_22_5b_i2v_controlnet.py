...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_5b_i2v_controlnet.json', 'source_id': 'wan22_5b_i2v_controlnet', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_5b_i2v_controlnet.json', 'output_mode': 'ready_template', 'ready_id': 'video/wanvideo_wrapper_22_5b_i2v_controlnet'},
)
