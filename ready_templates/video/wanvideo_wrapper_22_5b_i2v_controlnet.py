...
Source:  workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_5b_i2v_controlnet.json
...
READY_METADATA = ReadyMetadata.build(
    template_id='wanvideo_wrapper_22_5b_i2v_controlnet',
    ...
    provenance={'smoke_resolution': '256x256x5_frames', 'source_role': 'materialized_ready_python_template', 'source_workflow': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_5b_i2v_controlnet.json', 'approach': 'WanVideoWrapper 2.2 5B image-to-video ControlNet'},
...
def build() -> VibeWorkflow:
    ...
    param_int_116 = node(wf, 'INTConstant', '116',
        value=121,
    )
    param_width = node(wf, 'INTConstant', '117',
        value=1280,
    )
    param_height = node(wf, 'INTConstant', '118',
        value=704,
    )
    ...
    vhs__load_video = node(wf, 'VHS_LoadVideo', '98',
        ...
        frame_load_cap=param_int_116.out('VALUE'),
    )
    # ════ IMAGE PREP ════
    ...
    get_images_from_batch_indexed_113 = node(wf, 'GetImagesFromBatchIndexed', '113',
        widget_0='0',
        images=resized_image_101.out('IMAGE'),
    )
    ...
    wan_video_encode_114 = node(wf, 'WanVideoEncode', '114',
        widget_0=False,
        widget_1=272,
        widget_2=272,
        widget_3=144,
        ...
        widget_5=0,
        widget_6=1,
        image=get_images_from_batch_indexed_113.out(0),
        vae=wan_video_vaeloader.out(0),
    )
    # ════ OUTPUT ════
    preview_image_115 = node(wf, 'PreviewImage', '115',
        images=get_images_from_batch_indexed_113.out(0),
    )
    ...
    wan_video_empty_embeds_106 = node(wf, 'WanVideoEmptyEmbeds', '106',
        ...
        widget_1=256,
        widget_2=5,
        extra_latents=wan_video_encode_114.out(0),
        height=param_height.out('VALUE'),
        width=param_width.out('VALUE'),
    )
