...
MODEL_NAME_4 = 'WanVideo\\S2V\\Wan2_2-S2V-14B_fp8_e4m3fn_scaled_KJ.safetensors'
POSE_ESTIMATOR_NAME = 'dw-ll_ucoco_384_bs5.torchscript.pt'
WAN = 'Wan'


PUBLIC_INPUT_METADATA = {
    'model': InputSpec(node='2', field='model_name', default=MODEL_NAME),
    'seed': InputSpec(node='112', field='seed', default=DEFAULT_SEED),
    'image': InputSpec(node='8', field='image', default='2b.jpg', aliases=('input_image',)),
    'width': InputSpec(node='109', field='width', default=640),
    'height': InputSpec(node='109', field='height', default=640),
}
...
READY_METADATA = ReadyMetadata.build(
    ...
    source_path='workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_s2v_framepack_pose.json',
    source_id='wan22_s2v_framepack_pose',
    source_type='api',
    source_workflow_path='workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_s2v_framepack_pose.json',
    source_hash='sha256:887315d87ce17ddfe92490e70ea450ddfe27d000fd56b9c4dca0dadaf300b401',
    output_mode='ready_template',
    ready_id='video/wanvideo_wrapper_22_s2v_framepack_pose',
    provenance={'source_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_s2v_framepack_pose.json', 'source_id': 'wan22_s2v_framepack_pose', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_s2v_framepack_pose.json', 'source_hash': 'sha256:887315d87ce17ddfe92490e70ea450ddfe27d000fd56b9c4dca0dadaf300b401', 'output_mode': 'ready_template', 'ready_id': 'video/wanvideo_wrapper_22_s2v_framepack_pose', 'source_workflow': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan22_s2v_framepack_pose.json'},
)
...
def build() -> VibeWorkflow:
    ...
    # Inputs
    image, mask = LoadImage(image='2b.jpg', unused_widget_1='image')
    ...
    image_load_2, frame_count_load, audio_load, video_info_load = VHS_LoadVideo(
    ...
    image_get_2, mask_get = GetImageRangeFromBatch(
        num_frames=DEFAULT_FRAMES,
        images=image_get,
    )
