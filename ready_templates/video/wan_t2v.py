...
def build() -> VibeWorkflow:
    ...
    bind_input(wf, 'width', '40', 'width', type='INT')
    bind_input(wf, 'height', '40', 'height', type='INT')
    bind_input(wf, 'frames', '40', 'length', type='INT')
    bind_input(wf, 'fps', '49', 'fps', type='FLOAT')
    bind_output(wf, '50', output_type='SaveVideo', name='video', artifact_kind='video', mime_type='video/mp4', filename_prefix='video/ComfyUI', expected_cardinality='one')
    return wf
