...
MODEL_NAME_4 = 'vae_approx\\taeltx2_3.safetensors'
MODEL_NAME_5 = 'gemma-3-12b-it-Q2_K.gguf'
MODEL_NAME_6 = 'LTXvideo\\LTX-2\\quantstack\\LTX-2.3-distilled-Q4_K_S.gguf'
MODEL_NAME_7 = 'LTX23_audio_vae_bf16_KJ.safetensors'
MODEL_NAME_8 = 'ltx-2.3-spatial-upscaler-x2-1.1.safetensors'
MODEL_NAME_9 = 'LTXVideo\\v2\\ltx-2.3-22b-distilled-1.1_transformer_only_fp8_scaled.safetensors'
PAD_COLOR = '0, 0, 0'
PIX_FMT = 'yuv420p'
RESIZE_TYPE = 'scale by multiplier'
SCALE_METHOD = 'area'
SCALE_METHOD_2 = 'lanczos'
...
def PUBLIC_INPUTS(**nodes):
    ...
    positive_ltx = nodes['positive_ltx']
    image = nodes['image']
    randomnoise = nodes['randomnoise']
    cliptextencode_2 = nodes['cliptextencode_2']
    return {
    'enhance_prompt': InputSpec(node=prompt_enhancer, field='_un13773', default=False),
    'ref_strength': InputSpec(node=positive_ltx, field='strength', default=0.7),
...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/ltxvideo/runexx/LTX-2.3_Motion_Transfer_DWPose.json', 'source_id': 'LTX-2.3_Motion_Transfer_DWPose', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/ltxvideo/runexx/LTX-2.3_Motion_Transfer_DWPose.json', 'source_hash': 'sha256:fb082ac019da4cd41a525181f65d4607f3557c219305e2ada61614eb933608aa', 'output_mode': 'ready_template', 'ready_id': 'video/ltx2_3_runexx_motion_transfer_dwpose'},
)
...
def prompt_enhancer(
    *,
    ...
    # vibecomfy source hash: sha256:ddda6700de0e8c45a7cdaa03996386962f4224f7a6c6d29ac96d0d3a0de43be2
...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        vaeloaderkj = VAELoaderKJ(
            vae_name=MODEL_NAME_7,
            device='main_device',
            weight_dtype='bf16',
        )

        vaeloader_2 = VAELoader(vae_name=MODEL_NAME_4)
        unetloader = UNETLoader(unet_name=MODEL_NAME_9)
        ...
        loadaudio = LoadAudio(audio='(Verse).mp3', widget_1=None, widget_2=None)
        ...
        cliptextencode = CLIPTextEncode(text=prompt_enhancer, clip=dualcliploader)
        ...
        easy_showanything = raw_call('easy showAnything', '5238',
            widget_0='highly detailed, monochrime colors. Make this image come alive with fluid motion. \n\nA make boxer. \n\nHe is dancing in sync to the music ',
            anything=prompt_enhancer,
        )
        ...
        return wf.finalize(PUBLIC_INPUTS(**locals()), output_node=vhs_videocombine, output_type='VHS_VideoCombine', name='video', artifact_kind='video', mime_type='video/mp4', expected_cardinality='one', filename_prefix='AnimateDiff')
