...
READY_METADATA = ReadyMetadata.build(
    ...
    source_path='/Users/peteromalley/Documents/reigh-workspace/vibecomfy/ready_templates/video/wanvideo_wrapper_22_wan_animate_preprocess_kijai.py',
    source_id='video/wanvideo_wrapper_22_wan_animate_preprocess_kijai',
    source_type='ready_template',
    source_workflow_path='/Users/peteromalley/Documents/reigh-workspace/vibecomfy/ready_templates/video/wanvideo_wrapper_22_wan_animate_preprocess_kijai.py',
...
def build() -> VibeWorkflow:
    ...
    intconstant = INTConstant(_id='8', value=832)
    intconstant_2 = INTConstant(_id='9', value=480)
    ...
    image_4, width_2, height_2, _ = GetImageSizeAndCount(_id='17', image=image_2)
    ...
    blockifymask = BlockifyMask(_id='26', masks=mask_3)
    drawmaskonimage = DrawMaskOnImage(_id='27', image=image_2, mask=blockifymask)
    ...
    image_5, _, _, _ = GetImageSizeAndCount(_id='32', image=wanvideodecode)
