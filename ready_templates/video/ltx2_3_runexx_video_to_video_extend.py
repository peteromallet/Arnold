...
MODEL_NAME_7 = 'LTXvideo\\LTX-2\\quantstack\\LTX-2.3-distilled-Q4_K_S.gguf'
MODEL_NAME_8 = 'LTXVideo\\v2\\ltx-2.3-22b-distilled_transformer_only_fp8_scaled.safetensors'
MODEL_NAME_9 = 'ltx-2.3-spatial-upscaler-x2-1.1.safetensors'
PIX_FMT = 'yuv420p'
...
def PUBLIC_INPUTS(**nodes):
    ...
    cliptextencode_3 = nodes['cliptextencode_3']
    return {
    'enable_promptenhance': InputSpec(node=prompt_enhancer, field='_un1089', default=True),
    ...
    'negative_prompt': InputSpec(node=cliptextencode_3, field='text', default=DEFAULT_PROMPT, type='STRING', aliases=('negative',), media_semantics='text'),
    }
...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/ltxvideo/runexx/LTX-2.3_V2V_Extend_Any_Video.json', 'source_id': 'LTX-2.3_V2V_Extend_Any_Video', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/ltxvideo/runexx/LTX-2.3_V2V_Extend_Any_Video.json', 'source_hash': 'sha256:2d63f545d1cfc6e47f55682094dae29fa0177751eb513e934744fd2a30a1126b', 'output_mode': 'ready_template', 'ready_id': 'video/ltx2_3_runexx_video_to_video_extend'},
)
...
def prompt_enhancer(
    *,
    ...
    # vibecomfy source hash: sha256:980233181372f4106ef4fc78cdc5de6d2d3bc081c76ac31399309ea8e70920ef
...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        latentupscalemodelloader = LatentUpscaleModelLoader(model_name=MODEL_NAME_9)
        ...
        unetloader = UNETLoader(unet_name=MODEL_NAME_8)
        unetloadergguf = UnetLoaderGGUF(unet_name=MODEL_NAME_7)
        ...
        normalizeaudioloudness = NormalizeAudioLoudness(widget_0=-16, audio=audio)
