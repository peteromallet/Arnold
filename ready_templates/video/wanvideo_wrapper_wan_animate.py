...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan_animate.json', 'source_id': 'wan_animate', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan_animate.json', 'output_mode': 'ready_template', 'ready_id': 'video/wanvideo_wrapper_wan_animate'},
)
