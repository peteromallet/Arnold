...
def PUBLIC_INPUTS(**nodes):
    ...
    'width': InputSpec(node=image_image, field='width', default=640, type='INT'),
...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        # Loaders
        clipvisionloader = CLIPVisionLoader(clip_name=MODEL_NAME)
        ...
        return wf.finalize(PUBLIC_INPUTS(**locals()), output_node=vhs_videocombine, output_type='VHS_VideoCombine', name='video', artifact_kind='video', mime_type='video/mp4', expected_cardinality='one', filename_prefix='WanVideoWrapper_I2V')
