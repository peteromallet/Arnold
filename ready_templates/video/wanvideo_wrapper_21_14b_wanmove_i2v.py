...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        wf._set_id_map({name: node.node.id for name, node in (('loadwanvideot5textencoder', loadwanvideot5textencoder), ('wanvideomodelloader', wanvideomodelloader), ('wanvideotorchcompilesettings', wanvideotorchcompilesettings), ('wanvideovaeloader', wanvideovaeloader), ('wanvideoblockswap', wanvideoblockswap), ('loadimage', loadimage), ('clipvisionloader', clipvisionloader), ('wanvideoloraselect', wanvideoloraselect), ('primitivenode', primitivenode), ('primitivenode_2', primitivenode_2), ('primitivenode_3', primitivenode_3), ('wanvideotextencode', wanvideotextencode), ('imageresizekjv2', imageresizekjv2), ('wanvideosetloras', wanvideosetloras), ('wanvideoclipvisionencode', wanvideoclipvisionencode), ('wanvideosetblockswap', wanvideosetblockswap), ('splineeditor', splineeditor), ('repeatimagebatch', repeatimagebatch), ('wanvideoimagetovideoencode', wanvideoimagetovideoencode), ('wanvideoaddwanmovetracks', wanvideoaddwanmovetracks), ('wanvideosampler', wanvideosampler), ('wanvideowandrawwanmovetracks', wanvideowandrawwanmovetracks), ('wanvideodecode', wanvideodecode), ('vhs_videocombine', vhs_videocombine), ('wanvideowandrawwanmovetracks_2', wanvideowandrawwanmovetracks_2), ('vhs_videocombine_2', vhs_videocombine_2))})
