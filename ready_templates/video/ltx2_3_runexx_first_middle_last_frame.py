...
def PUBLIC_INPUTS(**nodes):
    ...
    positive_ltxv_3 = nodes['positive_ltxv_3']
    ...
    'middleframe_strength': InputSpec(node=positive_ltxv_3, field='num_guides.strength_2', default=0.3),
    'seed': InputSpec(node=randomnoise, field='noise_seed', default=DEFAULT_SEED, type='INT'),
    'image': InputSpec(node=image_load, field='image', default='sodacan_01.png', type='IMAGE', required=True, aliases=('input_image',), media_semantics='image'),
...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/ltxvideo/runexx/LTX-2.3_FML2V_First_Middle_Last_Frame_guider.json', 'source_id': 'LTX-2.3_FML2V_First_Middle_Last_Frame_guider', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/ltxvideo/runexx/LTX-2.3_FML2V_First_Middle_Last_Frame_guider.json', 'source_hash': 'sha256:0f31ad234be61dcf7bf5a2e53006665fb85b51971c22bc1f9adcd0493a09f119', 'output_mode': 'ready_template', 'ready_id': 'video/ltx2_3_runexx_first_middle_last_frame'},
)
...
def prompt_enhancer(
    *,
    ...
    # vibecomfy source hash: sha256:84761dc5c2ffb4cde9e6bd25492cca75fb48d686afcfe0ec14f7a763230e9beb
...
def frames_split_view():
    ...
    # vibecomfy source hash: sha256:fc1003493e9da0e4655fad5d2b23b3b425f69dbe8597904c9fc5f03f8adf4b81
