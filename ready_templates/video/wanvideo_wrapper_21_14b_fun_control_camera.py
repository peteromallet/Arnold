...
def build() -> VibeWorkflow:
    ...
    wanvideomodelloader = _node(wf, 'WanVideoModelLoader', '22',
        widget_0='WanVideo\\Wan2.1-Fun-V1.1-1.3B-Control-Camera.safetensors',
        widget_1='bf16',
        widget_2='disabled',
    ...
    reroute = _node(wf, 'Reroute', '80')
    getnode = _node(wf, 'GetNode', '85',
        widget_0='VAE',
    )
    getnode_2 = _node(wf, 'GetNode', '86',
        widget_0='VAE',
    )
    getnode_3 = _node(wf, 'GetNode', '89',
        widget_0='InputImage',
    )
    ...
    intconstant = _node(wf, 'INTConstant', '105',
        widget_0=81,
    )
    wanvideotextencode = _node(wf, 'WanVideoTextEncode', '16',
        widget_0='high quality video of an old man',
    ...
    imageresizekjv2 = _node(wf, 'ImageResizeKJv2', '97',
        height=256,
        widget_0=256,
        widget_1=256,
        widget_2='lanczos',
    ...
    ade_cameraposebasic = _node(wf, 'ADE_CameraPoseBasic', '99',
        widget_0='Zoom Out',
        widget_1=0.10000000000000002,
        widget_2=40,
        frame_length=intconstant.out(0),
    )
    ...
    setnode_2 = _node(wf, 'SetNode', '98',
        widget_0='InputImage',
        IMAGE=imageresizekjv2.out(0),
    )
    cameraposevisualizer = _node(wf, 'CameraPoseVisualizer', '102',
        widget_0='',
        widget_1=0.2,
        widget_2=0.3,
        widget_3=1,
    ...
    wanvideofuncameraembeds = _node(wf, 'WanVideoFunCameraEmbeds', '104',
        widget_0=832,
        widget_1=480,
        widget_2=1,
        widget_3=0,
    ...
    wanvideoimagetovideoencode = _node(wf, 'WanVideoImageToVideoEncode', '63',
        ...
        widget_6=True,
        widget_7=True,
        control_embeds=wanvideofuncameraembeds.out(0),
        height=imageresizekjv2.out(2),
        num_frames=intconstant.out(0),
        start_image=setnode_2.out(0),
        vae=getnode.out(0),
        width=imageresizekjv2.out(1),
    )
    previewimage = _node(wf, 'PreviewImage', '103',
        images=cameraposevisualizer.out(0),
    )
    imageconcatmulti = _node(wf, 'ImageConcatMulti', '87',
        ...
        widget_2=True,
        widget_3=None,
        image_1=wanvideodecode.out(0),
        image_2=getnode_3.out(0),
        image_3=cameraposevisualizer.out(0),
    )
