...
PUBLIC_INPUT_METADATA = {
    ...
    'prompt': InputSpec(node='15', field='text', default=DEFAULT_PROMPT_2),
    'seed': InputSpec(node='28', field='seed', default=DEFAULT_SEED),
    'image': InputSpec(node='9', field='image', default='pasted/image (758).png', aliases=('input_image',)),
    'width': InputSpec(node='17', field='width', default=640),
}
...
READY_METADATA = ReadyMetadata.build(
    ...
    source_path='workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan21_14b_fun_control.json',
    source_id='wan21_14b_fun_control',
    source_type='api',
    source_workflow_path='workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan21_14b_fun_control.json',
    source_hash='sha256:68af40bb2e84094ef559a7105655702f22e90cc3aeef396ae96fd2c5b7be1104',
    output_mode='ready_template',
    ready_id='video/wanvideo_wrapper_21_14b_fun_control',
    provenance={'source_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan21_14b_fun_control.json', 'source_id': 'wan21_14b_fun_control', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan21_14b_fun_control.json', 'source_hash': 'sha256:68af40bb2e84094ef559a7105655702f22e90cc3aeef396ae96fd2c5b7be1104', 'output_mode': 'ready_template', 'ready_id': 'video/wanvideo_wrapper_21_14b_fun_control', 'source_workflow': 'workflow_corpus/custom_nodes/wanvideo_wrapper/kijai/wan21_14b_fun_control.json'},
)
...
def build() -> VibeWorkflow:
    ...
    return wf.finalize(PUBLIC_INPUT_METADATA, output_node=vhs_videocombine, output_type='VHS_VideoCombine', name='video', artifact_kind='video', mime_type='video/mp4', expected_cardinality='one', filename_prefix='control')
