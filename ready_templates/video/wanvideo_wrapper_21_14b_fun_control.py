...
MODEL_NAME_2 = 'clip_vision_h.safetensors'
MODEL_NAME_3 = 'depth_anything_v2_vitl_fp16.safetensors'
MODEL_NAME_4 = 'WanVideo\\wan2.1_fun_control_1.3B_bf16.safetensors'
MODEL_NAME_5 = 'umt5-xxl-enc-bf16.safetensors'
MODEL_NAME_6 = 'wanvideo\\Wan2_1_VAE_bf16.safetensors'
PIX_FMT = 'yuv420p'
PRECISION = 'bf16'
...
def PUBLIC_INPUTS(**nodes):
    ...
    image = nodes['image']
    image_image_2 = nodes['image_image_2']
    cliptextencode = nodes['cliptextencode']
    return {
    'seed': InputSpec(node=samples, field='seed', default=DEFAULT_SEED, type='INT'),
    'image': InputSpec(node=image, field='image', default='pasted/image (758).png', type='IMAGE', required=True, aliases=('input_image',), media_semantics='image'),
    'width': InputSpec(node=image_image_2, field='width', default=640, type='INT'),
...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        loadwanvideot5textencoder = LoadWanVideoT5TextEncoder(model_name=MODEL_NAME_5)
        wanvideomodelloader = WanVideoModelLoader(model=MODEL_NAME_4)
        wanvideotorchcompilesettings = WanVideoTorchCompileSettings()
        wanvideovaeloader = WanVideoVAELoader(model_name=MODEL_NAME_6)
        ...
        clipvisionloader = CLIPVisionLoader(clip_name=MODEL_NAME_2)
        ...
        return wf.finalize(PUBLIC_INPUTS(**locals()), output_node=vhs_videocombine, output_type='VHS_VideoCombine', name='video', artifact_kind='video', mime_type='video/mp4', expected_cardinality='one', filename_prefix='WanVideoWrapper_FunControl')
