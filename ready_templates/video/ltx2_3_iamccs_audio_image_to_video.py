...
MODEL_NAME_2 = 'ltx-2-19b-distilled.safetensors'
MODEL_NAME_3 = 'ltx-2-19b-distilled-lora-384.safetensors'
MODEL_NAME_4 = 'gemma_3_12B_it_fp8_e4m3fn.safetensors'
MODEL_NAME_5 = 'LTX2_video_vae_2_bf16.safetensors'
MODEL_NAME_6 = 'ltx-2-19b-embeddings_connector_dev_bf16.safetensors'
MODEL_NAME_7 = 'MelBandRoformer_fp32.safetensors'
MODEL_NAME_8 = 'LTX2_audio_vae_bf16.safetensors'
MODEL_NAME_9 = 'ltx-2-19b-lora-camera-control-static.safetensors'
WEIGHT_DTYPE = 'bf16'
WIDGET_0 = 'auto'
WIDGET_0_2 = 'tiny'
WIDGET_1 = '1.7B'
...
def PUBLIC_INPUTS(**nodes):
    ...
    image_image = nodes['image_image']
    seed__rgthree_ = nodes['seed__rgthree_']
...
READY_METADATA = ReadyMetadata.build(
    ...
    provenance={'source_path': 'workflow_corpus/custom_nodes/ltxvideo/iamccs/IAMCCS_LTX2_AU_IMG2V.json', 'source_id': 'IAMCCS_LTX2_AU_IMG2V', 'source_type': 'api', 'source_workflow_path': 'workflow_corpus/custom_nodes/ltxvideo/iamccs/IAMCCS_LTX2_AU_IMG2V.json', 'source_hash': 'sha256:7639acd4c14cd183c8049772340538ae7a4fef596a4bdf4710d21adb0bcde97a', 'output_mode': 'ready_template', 'ready_id': 'video/ltx2_3_iamccs_audio_image_to_video'},
)
...
def build() -> VibeWorkflow:
    ...
    with new_workflow(READY_METADATA, source_path=__file__) as wf:
        ...
        loadaudio = LoadAudio(audio='man voice 1.mp3', widget_1=None, widget_2=None)
        ...
        unetloadergguf = UnetLoaderGGUF(unet_name=MODEL_NAME)
        ...
        loadaudio_3 = LoadAudio(audio='EdgarLetfall.mp3', widget_1=None, widget_2=None)
        melbandroformermodelloader = raw_call('MelBandRoFormerModelLoader', '377', widget_0=MODEL_NAME_7)
        cr_float_to_integer = raw_call('CR Float To Integer', '384', _float=25.0)
        load_whisper__mtb_ = raw_call('Load Whisper (mtb)', '405', widget_0=WIDGET_0_2, widget_1=True)
        ltxvaudiovaeloader = LTXVAudioVAELoader(ckpt_name=MODEL_NAME_2)

        ltxvgemmaclipmodelloader = LTXVGemmaCLIPModelLoader(
            gemma_path=MODEL_NAME_4,
            ltxv_path=MODEL_NAME_2,
        )

        model, clip, vae = CheckpointLoaderSimple(ckpt_name=MODEL_NAME_2)
        load_whisper__mtb__2 = raw_call('Load Whisper (mtb)', '433', widget_0=WIDGET_0_2, widget_1=True)
        ...
        return wf.finalize(PUBLIC_INPUTS(**locals()), output_node=vhs_videocombine, output_type='VHS_VideoCombine', name='video', artifact_kind='video', mime_type='video/mp4', expected_cardinality='one', filename_prefix='IAMCCS/LTX2_AU+IMG2V')
