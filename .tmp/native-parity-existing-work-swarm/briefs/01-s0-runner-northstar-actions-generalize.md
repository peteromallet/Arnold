# Swarm audit: S0 Runner Pin + North Star Action Core [adjacent/generalizable mechanisms]
...
Component: S0 Runner Pin + North Star Action Core
Component scope: runner pinning, north_star_actions, gate/carry schema, revise prompt/action validation, human-halt, severity normalization
