# Swarm audit: S1b Deterministic Evidence Substrate [adjacent/generalizable mechanisms]
...
Component: S1b Deterministic Evidence Substrate
Component scope: replay harness, split-outcome inventory, baseline freeze, headless control injection, installed-package source-loading smoke, canonicalizer if artifact hashes are used
