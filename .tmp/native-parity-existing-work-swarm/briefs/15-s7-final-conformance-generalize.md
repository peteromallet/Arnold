# Swarm audit: S7 Final Generated Conformance + Rollout [adjacent/generalizable mechanisms]
...
Component: S7 Final Generated Conformance + Rollout
Component scope: checkout and installed strict checker, final carrier scan/reconciliation, scenario-row matrix, exemption closeout, generated conformance report, rollout/drain decision, runtime narrowing
Lens: adjacent/generalizable mechanisms
Lens instruction: Find adjacent mechanisms that are not identical but could be generalized into this component; identify risks and refactor path.
