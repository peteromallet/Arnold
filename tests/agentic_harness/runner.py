...
def _default_scenarios_dir() -> Path:
    return _resolve_repo_root() / "tests" / "agentic_harness" / "scenarios"


def _default_briefs_dir() -> Path:
    return _resolve_repo_root() / "tests" / "agentic_harness" / "briefs"
...
def main(argv: list[str] | None = None) -> dict[str, Any]:
    ...
    Usage: python -m tests.agentic_harness.runner [--mode structural] [--actor fake] [--tag run]
    """
    parser = build_parser()
