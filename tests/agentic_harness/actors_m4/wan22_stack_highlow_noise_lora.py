...
from tests.agentic_harness.actors import _write_actions, _write_placeholder, _write_workflow_evidence
...
def build_m4_wan22_stack_highlow_noise_lora_evidence(report_dir: Path) -> dict[str, Any]:
    ...
    evidence = _write_workflow_evidence(
        ...
        origin=(
            "agentic",
            "tests/agentic_harness/actors_m4/wan22_stack_highlow_noise_lora.py:build_m4_wan22_stack_highlow_noise_lora_evidence",
        ),
    )
    _write_actions(
        root / "actions.jsonl",
