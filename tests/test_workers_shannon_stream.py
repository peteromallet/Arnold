...
from arnold.pipelines.megaplan.workers._impl import session_key_for
...
def test_shannon_stream_config_is_limited_to_stream_knobs() -> None:
    from arnold.pipelines.megaplan.workers.shannon_stream import ShannonStreamConfig
...
def test_build_shannon_stream_env_preserves_subscription_auth_and_locks_updates(
    ...
    from arnold.pipelines.megaplan.workers.shannon_stream import build_shannon_stream_env
...
def test_shannon_stream_liveness_counts_parsed_stdout_ndjson_as_progress(
    ...
    from arnold.pipelines.megaplan.workers.shannon_stream import make_shannon_stream_liveness
...
def test_build_shannon_stream_command_write_mode_uses_native_stream_and_bypass(
    ...
    from arnold.pipelines.megaplan.workers.shannon_stream import build_shannon_stream_command
...
def test_shannon_stream_safety_text_states_os_user_boundary() -> None:
    import arnold.pipelines.megaplan.workers.shannon_stream as shannon_stream
...
def test_parse_shannon_stream_output_accepts_drifted_native_events() -> None:
    from arnold.pipelines.megaplan.workers.shannon_stream import parse_shannon_stream_output
...
def test_run_shannon_stream_step_launches_native_claude_and_builds_worker_result(
    ...
    import arnold.pipelines.megaplan.workers.shannon_stream as shannon_stream
    from arnold.pipelines.megaplan.workers._impl import CommandResult
...
def test_native_stream_turn_pre_sleep_does_not_hold_host_turn_slot(
    ...
    import arnold.pipelines.megaplan.workers.shannon_stream as shannon_stream
    from arnold.pipelines.megaplan.workers._impl import CommandResult
    from arnold.pipelines.megaplan.workers.shannon_session import Turn
