...
def test_main_normalizes_execute_wrapper_flags_before_subcommand(monkeypatch) -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--actor", default=None)
    parser.add_argument("--backend", default=None)
    sub = parser.add_subparsers(dest="command", required=True)
...
def test_main_infers_execute_for_execute_only_wrapper_flags(monkeypatch) -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--actor", default=None)
    parser.add_argument("--backend", default=None)
    sub = parser.add_subparsers(dest="command", required=True)
    ...
    execute.add_argument("--plan", default=None)
    execute.add_argument("--project-dir", default=None)
    execute.add_argument("--confirm-destructive", action="store_true")
    execute.add_argument("--user-approved", action="store_true")
    execute.add_argument("--retry-blocked-tasks", action="store_true")
