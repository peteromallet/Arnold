...
def test_disposition_terminal_links_existing_record_once(tmp_path: Path):
    ...
    _accepted(ledger, reservation_event_id=r["payload"]["event_id"], admission_receipt_id=receipt, physical_door_id="default-door", phase="ph", selected_spec="spec", primary_spec="spec", logical_dispatch_id="log", worker_identity=WORKER, started_at="2026-01-01T00:00:00Z", finished_at="2026-01-01T00:00:01Z")
