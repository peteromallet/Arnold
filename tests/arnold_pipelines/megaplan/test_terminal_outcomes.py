...
def test_disposition_terminal_links_existing_record_once(tmp_path: Path):
    ...
    ledger.append_controlled_adapter_state(reservation_event_id=r["payload"]["event_id"], admission_receipt_id=receipt, physical_door_id="default-door", launch_state_identity="not_started")
    ledger.append_controlled_adapter_state(reservation_event_id=r["payload"]["event_id"], admission_receipt_id=receipt, physical_door_id="default-door", launch_state_identity="entered")
