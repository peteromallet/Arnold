...
- C1 owns the experimental neutral package/import boundary, versioned schemas
  and serialization, stable obligation identity, durable/helper lint,
...
- Internal persisted-wire compatibility starts at authoritative S2R GO-0.
  Stable public API publication remains Platform S6-only.
