...
```text
/Users/peteromalley/Documents/Arnold/.megaplan/initiatives/arnold-complete-cleanup-single-root/briefs/chain.yaml
```
...
```text
/Users/peteromalley/Documents/Arnold/.megaplan/initiatives/workflow-manifest-runtime/briefs/chain.yaml
```
