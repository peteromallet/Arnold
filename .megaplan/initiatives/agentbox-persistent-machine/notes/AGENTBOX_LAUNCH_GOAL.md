...
.megaplan/initiatives/agentbox-persistent-machine/briefs/launch-after-python-shaped-m3.sh
```
...
```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/chain.yaml
```
...
```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m1-arnold-runtime-core.md
```

### M2 — AgentBox Host Provider

```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m2-agentbox-host-provider.md
```

### M3 — Megaplan Chain Adapter

```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m3-megaplan-chain-adapter.md
```

### M4 — Discord Thin Path

```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m4-discord-thin-path.md
```

### M5 — Guardian V0

```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m5-guardian-v0.md
```

### M6 — Credentials Preflight

```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m6-credentials-preflight.md
```

### M7 — Completion, GitHub, And Cleanup

```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m7-completion-github-cleanup.md
```

### M8 — Bootstrap And Day-2 Operations

```text
/Users/peteromalley/Documents/megaplan/.megaplan/initiatives/agentbox-persistent-machine/briefs/m8-bootstrap-day2.md
```
