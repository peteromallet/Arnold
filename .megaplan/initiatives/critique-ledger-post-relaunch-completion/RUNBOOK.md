...
failure bytes, the terminal B27/B28/B29 live receipts lack imported bytes, B30
...
4. Preserve B26's independent Sol GO and B27/B28/B29's offline and terminal
   failed-live evidence, then copy and independently review B30's passing
   non-overwriting offline smoke. B8-B10 build failures and B10-B25 smoke
   failures remain immutable evidence.
5. Import and reconcile transaction `404dd858567d48ffbe8cb7c27d85185a`'s
   durable failure receipt and import B27/B28/B29's already-terminal run receipts.
   Only after B30 is accepted: obtain fresh predeploy authority, use its
   isolated attempt-4 workspace/container, run a new supported live transaction, apply
