...
### F1 P2 control-plane hardening (tracked mapping)
...
### F2 P2 control-plane hardening (tracked mapping)

- [ ] Require one admission token for every launch/resume/override/adoption
...
- [ ] Use one canonical, role-scoped provider resolver for orchestration/task/
  validation authority and verify it before lease/resource acquisition and on
  resume.
...
- [ ] Issue one custody-complete admission token composing WBC, Run Authority,
  and Custody; do not create a competing authority ledger.
