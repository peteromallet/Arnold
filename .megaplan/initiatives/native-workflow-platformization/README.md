...
Internal persisted-wire compatibility for completion records begins at Native
S2R's authoritative GO-0 enablement. Platform S6 decides the stable public
authoring/API promise after the unrelated consumer; it does not retroactively
create storage compatibility.
