...
Internal persisted-wire compatibility and authoritative decoder behavior begin
at Native S2R GO-0. Platform S6 freezes only the public authoring/API surface
proven by both consumers; it does not originate or retroactively redefine
