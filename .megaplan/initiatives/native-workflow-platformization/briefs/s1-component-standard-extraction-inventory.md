...
- Completion candidate outcomes and platform enforcement dispositions remain
  ...
  translation table.
- The Native S2R persisted-wire and authoritative-decoder compatibility promise
  is inherited unchanged. S1 records it; no Platform milestone before S6
  publishes a stable public authoring or API surface.
...
2. Freeze the package-direction and extraction inventory. Record dependency
   ...
   all remaining Megaplan coupling. Do not redesign or copy any of them.
...
- Conformance/traceability skeletons enumerate all 37 acceptance-suite families
