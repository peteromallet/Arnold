...
promise begins at S2R GO-0 and is inherited unchanged. Platform S6 governs
stable public authoring/API publication; it does not retroactively create or
reinterpret storage compatibility.
...
numeric values, or extended by a consumer-local table.
