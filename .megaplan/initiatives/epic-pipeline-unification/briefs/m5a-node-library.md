...
**Epic:** Pipeline Unification (`briefs/pipeline-unification-EPIC.md`). Authoritative sequencing:
`briefs/validation/sequencing/PROGRAM.md` §201–214 (M5a entry) + the critical-path/strangler/open-risks
context. Organ specs: `briefs/validation/committed-uu/SYNTHESIS.md` (node library §112–148 of EPIC;
R6 Manifest §297–305, §379–381, §485). Open questions resolved from
`briefs/validation/human-blockers/REGISTER.md` §M5a (line 108).
