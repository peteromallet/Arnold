...
Parent: `briefs/pipeline-unification-EPIC.md` (M2 entry EPIC:138–141; **Structural pieces #1 — the Port,
EPIC:95–101 — the keystone**; "Primitive contract — evidence-backed" EPIC:56–77 — all authoritative).
Evidence sources: `briefs/validation/decision/abstraction-stress-test.md` (verdict: verbs are at the right
altitude, the **types** are planning-shaped) and `briefs/validation/interrogation/SYNTHESIS.md` (**Theme A —
