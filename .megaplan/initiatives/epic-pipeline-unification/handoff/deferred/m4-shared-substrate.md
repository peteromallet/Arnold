...
**Epic:** Pipeline Unification (`briefs/pipeline-unification-EPIC.md`, m4 §89–102; Guiding principle §7–17).
...
**Grounded:** 2026-05-28 against current main. **Findings:** `briefs/validation/{c3-emission,c4-handlercontext,c5-realizer}.md`,
`briefs/validation/premortem/{p1-blast-radius,p5-overengineering}.md`.
