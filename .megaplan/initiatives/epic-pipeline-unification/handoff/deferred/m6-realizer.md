...
**Epic:** Pipeline Unification (`briefs/pipeline-unification-EPIC.md`, m6 §132–141, validation-change #7 §49–51).
...
**Grounded:** 2026-05-28 against current main. **Definitive findings:** `briefs/validation/c5-realizer.md`, `briefs/validation/c7-pr43.md`.
