...
9. Compile task objectives, success criteria, intended write sets, tests, sense
   ...
   unscoped or unverifiable proposals before shadow dispatch. Authors declare
   intent and domain obligations once on the canonical surface; generated
   mechanical obligations, pinned bindings, and human-readable completion
   worksheets/reports require no synchronized hand-authored registry. Delete
   and regenerate those projections during the fixture and prove their absence
   cannot affect evaluation or acceptance. Pure helpers remain contract-free.
10. Bind every finalized dynamic task/rework occurrence exactly once through
    ...
    immutable binding as a new admission whose record references the prior
    subject/binding without mutating or rebinding it; admit genuinely new work
    under a new stable ID; or
