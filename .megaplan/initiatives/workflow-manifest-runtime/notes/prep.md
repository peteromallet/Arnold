...
- `.megaplan/initiatives/workflow-manifest-runtime/briefs/chain.yaml`

Companion review and setup context:

- `.megaplan/initiatives/workflow-manifest-runtime/briefs/review-synthesis.md`
- `.megaplan/initiatives/workflow-manifest-runtime/briefs/chain-notes.md`
...
PYENV_VERSION=3.11.11 python -m arnold.pipelines.megaplan chain start \
  --spec .megaplan/initiatives/workflow-manifest-runtime/briefs/chain.yaml \
  --project-dir "$PWD" \
  --one
```
