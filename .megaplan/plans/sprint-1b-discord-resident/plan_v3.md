...
2. **Validate** in CI/test bootstrap that no committed file matches the leaked JWT prefix `[REDACTED_SUPABASE_JWT_PREFIX]` (cheap grep guard; pytest fixture or `tools/check_no_secrets.sh`).
