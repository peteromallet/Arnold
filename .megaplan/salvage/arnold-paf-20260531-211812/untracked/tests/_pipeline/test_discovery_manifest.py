...
def test_well_formed_manifest(tmp_path: Path) -> None:
    ...
    assert result.name == "demo_pipeline"
...
def test_well_formed_module_file_derives_name_from_stem(tmp_path: Path) -> None:
...
@pytest.mark.parametrize("missing_field", ["description", "supported_modes", "driver"])
