# Wave 3 Design/Elegance Challenge: Safety Policy

You are an independent DeepSeek reviewer. Use the updated plan below. Your lens: Whether safe/confirm/forbidden rules are clear enough without slowing the single-user flow.
