# Wave 1 UX Challenge: Failure and Recovery Language

You are an independent DeepSeek reviewer. Use the AgentBox context below. Your lens: Whether failure messages explain evidence, attempted repair, and the exact input needed from Peter.
