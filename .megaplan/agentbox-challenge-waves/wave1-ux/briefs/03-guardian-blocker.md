# Wave 1 UX Challenge: Guardian Blocker Repair Flow

You are an independent DeepSeek reviewer. Use the AgentBox context below. Your lens: Whether the Guardian flow actively diagnoses, fixes, and relaunches blocked work instead of merely reporting.
