# Wave 1 UX Challenge: Ticket Epic Megaplan Chain Intent

You are an independent DeepSeek reviewer. Use the AgentBox context below. Your lens: Whether the Operator can correctly classify add-ticket, setup-epic, setup-megaplan, run-chain, status, and maintenance requests.
