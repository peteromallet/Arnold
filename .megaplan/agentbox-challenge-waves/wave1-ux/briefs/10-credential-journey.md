# Wave 1 UX Challenge: Credential Push and Missing Credential Journey

You are an independent DeepSeek reviewer. Use the AgentBox context below. Your lens: Whether credential setup/sync/test/missing-credential recovery is understandable and not scary.
