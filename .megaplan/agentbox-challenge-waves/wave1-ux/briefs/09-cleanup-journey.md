# Wave 1 UX Challenge: Cleanup and Merge Journey

You are an independent DeepSeek reviewer. Use the AgentBox context below. Your lens: Whether remote worktree to PR to main to cleanup is understandable and safe from the user perspective.
