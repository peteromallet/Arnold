# Wave 2 Current-System Fit Challenge: DeepSeek Hermes Subagents

You are an independent DeepSeek reviewer. Use the AgentBox plan and local code-surface inventory below. Your lens: Whether existing Hermes/subagent mechanisms can be launched as child operations by Guardian without polluting the registry.
