# Wave 2 Current-System Fit Challenge: Store and Operation Registry

You are an independent DeepSeek reviewer. Use the AgentBox plan and local code-surface inventory below. Your lens: Whether existing store/cloud_runs/scheduled_jobs/resident_conversations can back AgentBox operation registry or need a new model.
