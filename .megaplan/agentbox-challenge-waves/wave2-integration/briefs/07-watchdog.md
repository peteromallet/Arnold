# Wave 2 Current-System Fit Challenge: Watchdog Integration

You are an independent DeepSeek reviewer. Use the AgentBox plan and local code-surface inventory below. Your lens: Whether watchdog/discovery/retry/repair should be a Guardian plugin and what duplicate-loop risks exist.
