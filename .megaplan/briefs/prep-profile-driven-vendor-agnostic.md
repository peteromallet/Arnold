...
**Related:** `.megaplan/briefs/prep-fanout-research-dossier.md` (original prep-fanout design), `.megaplan/briefs/multi-agent-fanout-primitive.md` (the cross-vendor parallel-fanout epic — this brief is its first concrete consumer)
