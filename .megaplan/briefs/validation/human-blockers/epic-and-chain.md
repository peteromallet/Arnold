...
Source docs:
- `.megaplan/briefs/pipeline-unification-EPIC.md`
- `.megaplan/briefs/epic-pipeline-unification/chain.yaml`
...
- Premade: **DEFAULT.** Author the canonical chain.yaml under `.megaplan/briefs/epic-pipeline-unification/` (it now exists)
