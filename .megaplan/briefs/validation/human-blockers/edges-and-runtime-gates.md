...
Sources: `.megaplan/briefs/validation/edges/{builder-docs,cli-migration,edges-map}.md`,
`megaplan/handlers/{execute,gate,override,verifiability,plan}.py`, `megaplan/cli/resolutions.py`,
`megaplan/auto.py`, `megaplan/chain/__init__.py`, `.megaplan/briefs/epic-pipeline-unification/m6-megaplan-as-module.md`.
...
`.megaplan/briefs/validation/edges/cli-migration.md` enumerates 3 FUZZY edges. They are **pre-decided** in that doc;
