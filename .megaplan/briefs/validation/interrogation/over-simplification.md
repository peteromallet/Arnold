...
**Grounded against:** `.megaplan/briefs/pipeline-unification-EPIC.md`, `.megaplan/briefs/epic-pipeline-unification/m5-extract-features.md`
(F1–F9), `m6-megaplan-as-module.md`, `.megaplan/briefs/validation/decision/migration-fit.md` (e1–e7),
`.megaplan/briefs/validation/confidence/a3-human-recovery.md`, and live code: `megaplan/handlers/override.py`,
