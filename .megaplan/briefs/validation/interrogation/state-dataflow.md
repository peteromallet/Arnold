...
Read against `.megaplan/briefs/pipeline-unification-EPIC.md`, `.megaplan/briefs/epic-pipeline-unification/{m2-deplanning-types,
m3-drivers-state}.md`, `.megaplan/briefs/validation/decision/{interface-feasibility,abstraction-stress-test}.md`,
and the live code (`megaplan/_pipeline/{executor,subloop,types,pattern_dynamic}.py`, `megaplan/_core/state.py`,
`.megaplan/briefs/validation/confidence/a2-concurrency.md`). Ambition fixed at full extraction; findings are
