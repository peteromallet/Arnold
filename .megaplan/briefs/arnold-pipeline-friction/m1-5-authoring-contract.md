...
- File a brief decision record (`.megaplan/briefs/arnold-pipeline-friction/decisions.md`) capturing the choices made.
...
- `.megaplan/briefs/arnold-pipeline-friction/decisions.md` (new)
