...
- `.megaplan/briefs/validation/sequencing/PROGRAM.md` **M2 entry (PROGRAM:105–123)** — delivers the Port + Contract
...
- `.megaplan/briefs/pipeline-unification-EPIC.md` — the data model (EPIC:51–67: `Port = kind × content-type × schema`
  + the binder + open MIME-like registry) and Structural-piece #1 (EPIC:174–184, the keystone).
- `.megaplan/briefs/validation/committed-uu/SYNTHESIS.md` — the **Contract Ledger** organ (SYNTHESIS:267–273), the
...
- `.megaplan/briefs/validation/human-blockers/REGISTER.md` — all M2 open questions resolved to defaults (REGISTER:105).
- PRIOR DRAFT `.megaplan/briefs/epic-pipeline-unification/m2-deplanning-types.md` — reused/re-aimed; all code-cites
