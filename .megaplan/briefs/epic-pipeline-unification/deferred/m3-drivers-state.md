...
`.megaplan/briefs/pipeline-unification-EPIC.md` — the **M3 entry** (L143-145), **Structural piece #2**
...
`.megaplan/briefs/validation/interrogation/SYNTHESIS.md` (**Theme B** — *both* criticals, the
...
"snapshot = copy the whole blob"), `.megaplan/briefs/validation/decision/{migration-fit,
interface-feasibility}.md`, `.megaplan/briefs/validation/confidence/a2-concurrency.md`, and
`.megaplan/briefs/validation/confidence/a3-human-recovery.md` **§4.4 (the parity test)**.
