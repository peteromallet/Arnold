...
**Epic:** Pipeline Unification (`.megaplan/briefs/pipeline-unification-EPIC.md` §m2). **Position:** m1 → **m2** (independent of m3/m4; depends only on m1's executor merge + parity gate). Run on a parallel branch off the m1 base. **Tier/robustness:** premium · thorough/high.
**Grounding:** `.megaplan/briefs/validation/c6-profiles.md` (claims 1–4 + the `tier_models` watch-item), `.megaplan/briefs/validation/premortem/p6-wrong-abstraction.md` (Arnold-is-not-a-pipeline), and code verified 2026-05-28.
