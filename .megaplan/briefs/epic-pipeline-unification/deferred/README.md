...
These are the v1 milestone briefs. After the pre-mortem (.megaplan/briefs/validation/premortem/SYNTHESIS.md)
the epic was re-aimed around the guiding principle: **share what other tools use; don't generalize
planning-only machinery.** See .megaplan/briefs/pipeline-unification-EPIC.md (v2) for the active plan.
