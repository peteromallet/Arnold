...
**Epic:** Pipeline Unification (`.megaplan/briefs/pipeline-unification-EPIC.md`). **Position:** m1 → **m2** (independent of m3–m6; delivers Arnold value earliest). **Tier/robustness:** premium · thorough/high.
**Grounding:** validated 2026-05-28 in `.megaplan/briefs/validation/c6-profiles.md` (claims 1–4 + the `tier_models` watch-item) and EPIC §"What the validation changed" #5.
