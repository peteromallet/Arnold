...
`.megaplan/briefs/validation/sequencing/PROGRAM.md` **M3 entry (L141-177)** + the critical-path apex
note (L340-346) + open risks 1,2,4 (L419-446); `.megaplan/briefs/pipeline-unification-EPIC.md` **the
eleven organs (L29-49), the data model (L51-67), the seven reshapers (L69-75)**; and the
organ specs in `.megaplan/briefs/validation/committed-uu/SYNTHESIS.md` (Activation L222-231; Conveyance
...
`.megaplan/briefs/validation/human-blockers/REGISTER.md` §3 (M3 line) + §2.
