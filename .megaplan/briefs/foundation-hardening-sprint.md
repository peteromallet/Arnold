...
disturb `main`. **Brief input:** this file + `.megaplan/briefs/planning-unification-FOUNDATION-AUDIT.md`
...
(`.megaplan/briefs/pipeline-unification-planning-as-pack.md`) will build on, so that epic starts on verified
