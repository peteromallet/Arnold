...
QUESTION: FQ-07
investigated_claim: Runtime B (77b76e3a4, the currently installed runtime) does NOT satisfy the chain's require_editable_runtime_match policy as recorded in chain state, and no canonical rebind/migration record authorizes A->B for this session.
...
DECISION THIS REPORT INFORMS: Horizon A in-place consideration vs authority-approved runtime migration/rebind record; ancestry alone is NOT authorization.
