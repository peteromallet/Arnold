...
> Companion (must land first): `01KSDH58ZPT54VWH7VXQ6PP4X3` → `briefs/subprocess-runtime-centralization.md`
...
>
> ```
> megaplan init briefs/cross-process-lifecycle-tmux-ownership.md \
