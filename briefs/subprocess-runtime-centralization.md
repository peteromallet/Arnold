...
> Suggested run: `partnered//medium` — `megaplan init briefs/subprocess-runtime-centralization.md --profile partnered --depth medium --in-worktree subprocess-runtime`
