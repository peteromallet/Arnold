...
**Status:** validation artifact, 2026-05-29. Derived from `briefs/pipeline-unification-EPIC.md`
("Structural pieces", "Resolved over-builds") + `briefs/validation/interrogation/SYNTHESIS.md`
...
- **FUZZY / VIOLATED.** The CLI is monolithic under `megaplan/cli/` with no umbrella/module split; the
  ...
  does not exist (see edge 9a). Cross-ref `briefs/cli-spec-model-override.md`.
