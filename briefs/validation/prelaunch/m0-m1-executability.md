...
**Triple:** `briefs/epic-pipeline-unification/{chain.yaml, m0-keepalive-floor.md, m1-foundation.md}`,
`briefs/validation/sequencing/PROGRAM.md`, `briefs/validation/human-blockers/REGISTER.md`.
...
in-chain per-step gate — and the briefs/REGISTER should say so. If in-chain enforcement is truly
