...
(`briefs/pipeline-unification-EPIC.md` + `briefs/epic-pipeline-unification/{chain.yaml, m0..m7}` +
`briefs/validation/{sequencing/PROGRAM.md, human-blockers/REGISTER.md}`) describes an autonomous,
