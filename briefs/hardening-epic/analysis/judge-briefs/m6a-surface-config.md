...
- RAW FACTS (already extracted from the run's Codex logs): /Users/peteromalley/Documents/megaplan/briefs/hardening-epic/analysis/m6a-surface-config-facts.md  <- READ THIS FIRST
- Original milestone brief (what was asked): briefs/hardening-epic/m6a-surface-config.md
- Raw logs (for spot-checking only): listed in /Users/peteromalley/Documents/megaplan/briefs/hardening-epic/analysis/manifests/m6a-surface-config-logs.txt
...
## Output
Write markdown to: /Users/peteromalley/Documents/megaplan/briefs/hardening-epic/analysis/m6a-surface-config-judgment.md
