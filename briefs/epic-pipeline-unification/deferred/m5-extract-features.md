...
**Epic:** Pipeline Unification (`briefs/pipeline-unification-EPIC.md`, m5 §106–109; Discipline table §29–38).
...
**Grounded:** 2026-05-28/29 against current main. **Findings:** `briefs/validation/decision/migration-fit.md`
(full feature surface + the (e1–e7) no-home gaps these pieces fill), `briefs/validation/confidence/a3-human-recovery.md`
(the control/override plane + `workflow_next` projection contract), `briefs/pipeline-unification-EPIC.md`
