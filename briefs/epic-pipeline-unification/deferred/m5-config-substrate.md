...
**Epic:** pipeline-unification (`briefs/pipeline-unification-EPIC.md`, m5 section L120–130).
**Tier/robustness:** premium · thorough/high.
**Depends on:** m1 (dispatch toggle, parity gate as permanent CI) and **m3 (auto.py in-process)**.
Grounded 2026-05-28. Primary findings: `briefs/validation/c4-handlercontext.md`,
`briefs/validation/s4-external-coupling.md`.
