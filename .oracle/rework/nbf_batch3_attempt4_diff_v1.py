#!/usr/bin/env python3
"""Deterministically frame the final Batch 3 attempt-4 candidate.

This Oracle-only tool consumes the explicit classified NBF04/NBF05 manifest.
It never walks the tree or includes Oracle artifacts implicitly.  Every record
is framed with fixed-width big-endian lengths and the aggregate is domain
separated, making the seal reproducible across runs.
"""
