# Settled-plan W4 — sequencing and verification lens
...
Find only material dependency, synchronization, crash/restart, propagation,
door-ordering, or evidence gaps that could invalidate a batch gate. Validation
must remain proportionate.

Return `PASS_SEQUENCE_AND_VERIFICATION` or ranked `SEQ4-N` findings with
