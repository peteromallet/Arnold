# Settled-plan W4 — simplification lens
...
Find only material duplicate ownership/state/abstraction/validation that still
prevents safe execution. Treat internal module organization and stylistic brevity
as non-material.

Return `PASS_NO_MATERIAL_SIMPLIFICATION` or ranked `SIMP4-N` findings with
materiality, exact evidence, smallest safe correction, criterion impact, and
North Star disposition. Under 650 words.
