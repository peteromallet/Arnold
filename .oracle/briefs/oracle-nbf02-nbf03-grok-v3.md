# Grok 4.6 Oracle gate brief — Batch 2 direct-subscription fresh gate
...
- Candidate HEAD: `5f172e3588e740bacd6692ca9e4cc50ae01f6a6b`
- Candidate parent commit: `5da26ec5be4d13559948fe4256a114ad7626482b`
- Candidate parent: `19deab5bb407273e7e82d40a66fc06d17af93ad4`
- Candidate tree: `e3d0376482154c4f95d2ec5809d630c4a0c32e69`
- Candidate sealed production-plus-focused-test digest: `5586c1861dce44334c3991e997bdc8b90b82d25d2ed8f28bb558b42aae499fd0`
- Blocked-gate bookkeeping commit: `5f172e3588e740bacd6692ca9e4cc50ae01f6a6b`
- Launch-failure receipt: `.oracle/receipts/oracle-nbf02-nbf03-grok-v2-launch-failure.md`, SHA `477eb4aec0374dadbc307ada8ee7ef4058830d0eeb1651b21e0fe3d41ad115ea`
...
The earlier OMP/OpenRouter HTTP 402 was a routing failure of the prior
wrapper path, not evidence that the direct Grok subscription is unavailable.
It is historical context only and must not be retried or treated as a Grok
subscription result.
...
The invocation owner must use the direct Grok subscription command below.
First run Grok as Oracle; Grok must then commission exactly one fresh independent
Luna/high reviewer. Do not create a second query, fallback, scout, nested
process, Sol review, or OMP/OpenRouter wrapper:
...
Grok must commission exactly one independent reviewer using the approved high
Luna route, and must verify the resolved model is GPT-5.6 Luna with thinking
high. The direct Grok command is the sole Oracle launch boundary; the previous
OMP/OpenRouter HTTP402 was a historical routing error and is not a subscription
availability result.
