# Settled-plan W3 — contract-completeness lens
...
Find only material contradictions or ownerless/unverifiable contracts across goal,
identity, atomicity, authority, state, dependency, signal scope, and acceptance.

Return `PASS_CONTRACT_COMPLETE` or ranked `CONTRACT3-N` findings with
materiality, exact plan/goal/source evidence, required correction, criterion
