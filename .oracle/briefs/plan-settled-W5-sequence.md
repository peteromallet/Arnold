# Settled-plan W5 — final sequence/verification lens
...
Return `PASS_SEQUENCE_AND_VERIFICATION` unless a remaining dependency, crash/
restart, door-ordering, or evidence gap could invalidate a declared batch PASS.
For any finding give exact evidence, smallest correction, criterion impact, and
North Star disposition. Under 500 words.
