# Settled-plan W5 — final simplification lens
...
Return `PASS_NO_MATERIAL_SIMPLIFICATION` unless a remaining duplicate authority,
store, scheduler, or task owner would materially undermine execution. For any
finding give exact contradictory evidence, smallest correction, criterion impact,
and North Star disposition. Under 500 words.
