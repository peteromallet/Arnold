# Settled-plan W6 — simplicity/scope consistency
...
Return `PASS_NO_MATERIAL_SIMPLIFICATION` unless the v6 correction introduced a
duplicate state owner, retry authority, reset rule, or unnecessary scope that
materially undermines execution. Cite exact evidence and smallest correction.
Under 600 words.
