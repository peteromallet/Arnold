...
- Deep-audit advisory (bind-root None guard) REJECTED: existing reviewed test contract defines explicit None as inert for non-threaded callers; sole production caller always passes root. Recorded for future hardening discussion.
