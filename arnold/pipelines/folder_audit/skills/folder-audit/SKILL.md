...
`folder-audit` is a native-default converted pipeline. Fresh runs through
`python -m arnold run folder-audit ...` or
`arnold pipelines run folder-audit ...` persist runtime ownership in
