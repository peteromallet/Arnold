...
from arnold.pipelines.megaplan._pipeline.step_helpers import next_version  # bridge: different signature
from arnold.pipelines.creative.prompts import render_prompt
