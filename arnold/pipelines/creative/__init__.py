...
per-stage prompt modules (under
``arnold/pipelines/creative/prompts/``). The default joke form uses
...
from arnold.pipelines.creative.prompts import CREATIVE_PROMPT_BUNDLE
from arnold.pipelines.creative.steps import CreativeStep
