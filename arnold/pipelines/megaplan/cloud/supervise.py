...
def _chain_tick_command(remote_spec_path: str, *, one_shot: bool = False) -> str:
    ...
    **M5d boundary note:** This function lives in the cloud tier, which is a
    ...
    """
    from arnold.pipelines.megaplan.cloud.cli import _chain_start_command as _cmd
...
def _remote_sync_refresh_command(
    ...
    *,
    ...
    """
    snippet = (
        "from arnold.pipelines.megaplan.chain import _capture_sync_state, ChainState, save_chain_state, load_chain_state; "
...
def cloud_supervise_tick(
    ...
    # ------------------------------------------------------------------
    from arnold.pipelines.megaplan.cloud.cli import _remote_human_verification_status_command
