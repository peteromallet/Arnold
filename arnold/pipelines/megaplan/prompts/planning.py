...
def _render_open_tickets(state: PlanState, plan_dir: Path) -> str:
    ...
    """
    try:
        from arnold.pipelines.megaplan.tickets import list_tickets as _tickets_list
        from arnold.pipelines.megaplan.tickets.core import _resolve_store, is_cloud_store
