...
from arnold.pipelines.megaplan.types import CRITIC_MODEL_CHOICES, DEFAULTS, _SETTABLE_BOOL, _SETTABLE_ENUM, _SETTABLE_NUMERIC
...
from arnold.pipelines.megaplan.quality_resolutions import VALID_RESOLUTIONS as QUALITY_VALID_RESOLUTIONS
...
def build_parser() -> argparse.ArgumentParser:
    ...
    from arnold.pipelines.megaplan.user_actions import VALID_RESOLUTIONS as _UA_VALID_RESOLUTIONS
    ...
    from arnold.pipelines.megaplan.auto import build_auto_parser

    build_auto_parser(subparsers)

    from arnold.pipelines.megaplan._pipeline.run_cli import build_run_parser

    build_run_parser(subparsers)

    from arnold.pipelines.megaplan.chain import build_chain_parser
    ...
    from arnold.pipelines.megaplan.prompts.tiebreaker_orchestrator import build_tiebreaker_parser
    ...
    pipelines_upgrade_cursor_parser.add_argument(
        "plan_dir",
        help="Plan directory containing resume_cursor.json",
    )
    pipelines_upgrade_mode = pipelines_upgrade_cursor_parser.add_mutually_exclusive_group()
    pipelines_upgrade_mode.add_argument(
        "--dry-run",
        action="store_true",
        default=False,
