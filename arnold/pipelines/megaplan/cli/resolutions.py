...
from arnold.pipelines.megaplan._core import load_plan, read_json
...
def handle_user_action(root: Path, args: argparse.Namespace) -> StepResponse:
    ...
    from arnold.pipelines.megaplan._core.state import save_state_merge_meta
    from arnold.pipelines.megaplan.blocker_recovery import build_prerequisite_scopes
    from arnold.pipelines.megaplan.handlers.shared import _append_to_meta
    from arnold.pipelines.megaplan.user_actions import VALID_RESOLUTIONS, build_resolution_event
    ...
    from arnold.pipelines.megaplan.resolutions import upsert_user_action_resolution
