...
from arnold.pipelines.megaplan._pipeline.step_helpers import next_version  # bridge
from arnold.pipeline import StepContext, StepResult
from arnold.pipelines.megaplan.pipelines.jokes.prompts import render_prompt
