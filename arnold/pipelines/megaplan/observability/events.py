...
if TYPE_CHECKING:
    ...
    from arnold.pipelines.megaplan.store import Store
...
class EventWriter:
    ...
    Typical usage (module-level singleton per plan_dir)::
        ...
        from arnold.pipelines.megaplan.observability.events import EventWriter
        ...
        *,
        ...
        with self._thread_lock:
            ...
            try:
                ...
                from arnold.pipelines.megaplan.observability.events_projection import write_projection
...
def emit_state_wal(
    ...
    *,
    ...
    if effect is not None:
        from arnold.pipelines.megaplan.observability.effect_ledger import Effect
    ...
    with open(ndjson_path, "r", encoding="utf-8") as fh:
        for line in fh:
            ...
            try:
                ...
                try:
                    from arnold.pipelines.megaplan._pipeline.flags import unified_emit_on
                    if unified_emit_on():
                        raise RuntimeError(
