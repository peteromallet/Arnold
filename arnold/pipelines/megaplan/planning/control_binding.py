...
from arnold.pipelines.megaplan._core import topology
...
class PlanningControlBinding:
    ...
    def apply_transition(
        ...
        if action == "set-profile":
            ...
            from arnold.pipelines.megaplan.profiles import load_profiles, profile_to_phase_models, resolve_profile
