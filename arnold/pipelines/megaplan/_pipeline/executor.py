...
from arnold.pipeline.types import ParallelStage as _GenericParallelStage
    ...
    *,
    ...
    while True:
        ...
        if _tpo() and getattr(pipeline, "binding_map", None) is not None:
            ...
            elif isinstance(node, (ParallelStage, _GenericParallelStage)):
        ...
        try:
            ...
            if isinstance(node, (ParallelStage, _GenericParallelStage)):
