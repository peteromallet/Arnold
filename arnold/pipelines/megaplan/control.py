...
from arnold.pipelines.megaplan._core import save_state, slugify
...
def _apply_gate_control_transition(
    ...
    *,
    ...
    from arnold.pipelines.megaplan._core.io import read_plan_state_cached
    from arnold.pipelines.megaplan.handlers.override import _emit_routed_override_events, _routed_override_response
