...
def promote_scratch(
    ...
    *,
    ...
    Raises:
        ValueError: When the scratch file was modified by the model but
            does not parse as valid JSON AND *file_fill_instructed* is
            ``True`` (``SD3`` — modified invalid scratch under file-fill
            instruction is a hard failure).
    """
    LOGGER.debug(
