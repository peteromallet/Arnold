...
from arnold.pipelines.megaplan import handlers as _pkg
...
def _apply_adaptive_critique_routing(
    ...
    from arnold.pipelines.megaplan.types import AgentMode as _TierAgentMode
    ...
    with load_plan_locked(root, args.plan, step="critique") as (plan_dir, state):
        ...
        if adaptive_path:
            ...
            if iteration >= 2:
                ...
                from arnold.pipelines.megaplan.prompts.critique import _plan_version_unified_diff
...
def _validate_tiebreaker(
    ...
    if blocklist and tiebreaker_flag_ids:
        from arnold.pipelines.megaplan._core import load_flag_registry as _load_flag_registry
...
from arnold.pipelines.megaplan.flags import apply_flag_verifications, update_flags_after_critique, update_flags_after_revise
