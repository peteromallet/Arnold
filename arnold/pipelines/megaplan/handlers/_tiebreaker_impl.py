...
from arnold.pipelines.megaplan.schemas.planning import TiebreakerDecision
...
from arnold.pipelines.megaplan._core import atomic_write_json, load_flag_registry, load_plan_locked, now_utc, read_json, require_state, save_flag_registry
...
def handle_tiebreaker_run(root: Path, args: argparse.Namespace) -> StepResponse:
    from arnold.pipelines.megaplan._core import workflow_transition
    with load_plan_locked(root, args.plan, step="tiebreaker-run") as (plan_dir, state):
        ...
        from arnold.pipelines.megaplan.prompts.tiebreaker_orchestrator import _run_tiebreaker
