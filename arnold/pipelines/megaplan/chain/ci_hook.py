...
from arnold.pipelines.megaplan.observability.fold import fold_equivalence_oracle
...
def gate_dual_green() -> GateOutcome:
    ...
    from arnold.pipelines.megaplan.chain.m3_dual_green import run_dual_green
...
def gate_supervisor_purity() -> GateOutcome:
    ...
    * Plus the existing M5 eval gates (bare-float judgments, second journals,
    ...
    """
    from arnold.pipelines.megaplan.chain.m5_eval_gates import run_m5_eval_gates, format_findings
