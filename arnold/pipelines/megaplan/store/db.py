...
# so that `from arnold.pipelines.megaplan.store import DBStore` works without psycopg installed.
try:
    import psycopg
...
from arnold.pipelines.megaplan.store.blob import LocalDirBlobStore, SupabaseStorageBlobStore
