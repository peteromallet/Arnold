...
from arnold.pipelines.megaplan._core.io import read_committed_framed_json_records
from arnold.pipelines.megaplan.schemas import EpicEvent
from arnold.pipelines.megaplan.schemas.base import utc_now
from arnold.pipelines.megaplan.store.base import StoredEvent
    ...
    def record_epic_event(
        ...
        *,
        ...
        if (
            ...
            from arnold.pipelines.megaplan.tickets import address_resolved_by_epic
