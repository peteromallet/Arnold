...
class _LazyColorsProxy:
    def __getattr__(self, name: str) -> Any:
        return getattr(_load_legacy_colors_module().Colors, name)


def color(*args: Any, **kwargs: Any) -> Any:
    return _load_legacy_colors_module().color(*args, **kwargs)


Colors = _LazyColorsProxy()
...
def _ensure_default_soul_md(home: Path) -> None:
    ...
    if soul_path.exists():
        return
    soul_path.write_text(_load_legacy_default_soul_md(), encoding="utf-8")
