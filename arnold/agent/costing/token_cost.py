...
def fetch_model_metadata() -> Dict[str, Dict[str, Any]]:
    """Fetch model metadata through the generic agent metadata seam.

    The import is lazy so importing neutral pipeline cost types never pulls in
    the legacy agent runtime. Tests may monkeypatch this module-level function.
    """
    from arnold.agent.agent.model_metadata import fetch_model_metadata as _fetch
...
def fetch_endpoint_model_metadata(
    ...
    """Fetch endpoint metadata through the generic agent metadata seam."""
    from arnold.agent.agent.model_metadata import fetch_endpoint_model_metadata as _fetch

    return _fetch(base_url, api_key=api_key or "")
