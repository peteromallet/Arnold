...
from arnold.agent.toolsets import resolve_toolset, validate_toolset
...
try:
    from arnold.agent.hermes_cli.plugins import discover_plugins
    discover_plugins()
except Exception as e:
...
def get_tool_definitions(
    ...
    if enabled_toolsets is not None:
        ...
        from arnold.agent.toolsets import get_all_toolsets
...
def handle_function_call(
    ...
    try:
        ...
        try:
            from arnold.agent.hermes_cli.plugins import invoke_hook
