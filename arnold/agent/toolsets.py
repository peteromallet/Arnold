...
Usage:
    from arnold.agent.toolsets import get_toolset, resolve_toolset, get_all_toolsets
...
TOOLSETS = {
    ...
    "file-readonly": {
        "description": "Read-only file tools: read file contents and search paths/content without any write capability",
