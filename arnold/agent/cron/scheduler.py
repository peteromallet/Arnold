...
from arnold.agent.cron.jobs import get_due_jobs, mark_job_run, save_job_output
...
def run_job(job: dict) -> tuple[bool, str, str, Optional[str]]:
    ...
    try:
        ...
        from arnold.agent.hermes_cli.runtime_provider import (
        ...
        from arnold.agent.agent.smart_model_routing import resolve_turn_route
