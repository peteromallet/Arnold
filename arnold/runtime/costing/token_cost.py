...
def fetch_model_metadata() -> Dict[str, Dict[str, Any]]:
    """Return model metadata from the generic agent metadata seam.

    The legacy SDK metadata seam (the old ``agent.agent.model_metadata``
    module) was removed in B11; there is no neutral metadata provider, so
    this returns an empty mapping and pricing lookups fall back to the
    official docs table. Tests may monkeypatch this module-level function
    or inject ``model_metadata_fetcher`` into ``get_pricing_entry``.
    """
    return {}
...
def fetch_endpoint_model_metadata(
    ...
    """Return endpoint model metadata for an OpenAI-compatible base URL.

    The legacy SDK metadata seam was removed in B11; no neutral provider
    exists, so this returns an empty mapping.
    """
    return {}
...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    (
        ...
        source="official_docs_snapshot",
        source_url="https://api-docs.deepseek.com/quick_start/pricing",
        pricing_version="deepseek-pricing-2026-04-26",
    ),
    (
        "deepseek",
        "deepseek-v4-pro",
        ...
        source="official_docs_snapshot",
        source_url="https://api-docs.deepseek.com/quick_start/pricing",
        pricing_version="deepseek-pricing-2026-04-26-discount-through-2026-05-31",
    ),
    # Google Gemini
    (
        "google",
