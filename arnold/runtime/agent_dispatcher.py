...
Implements :class:`arnold.runtime.agent_contracts.AgentDispatcher` Protocol.
...
class ArnoldDispatcher:
    ...
    Satisfies the :class:`~arnold.runtime.agent_contracts.AgentDispatcher`
    Protocol so it can be used anywhere a structural ``AgentDispatcher`` is
    expected.
    """
