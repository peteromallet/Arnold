...
from arnold.pipeline.types import Port, PortRef, Step, StepContext, StepResult
...
class ReceiptDecorator:
    ...
    @property
    def produces(self) -> tuple[Port, ...]:
        return getattr(self.inner, "produces", ())

    @property
    def consumes(self) -> tuple[PortRef, ...]:
        return getattr(self.inner, "consumes", ())
