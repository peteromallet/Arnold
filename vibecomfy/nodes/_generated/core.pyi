...
def ImageOnlyCheckpointLoader(
    *args: VibeWorkflow,
    _id: str | None = ...,
    ckpt_name: Literal['LTX23_audio_vae_bf16.safetensors', 'ltx-2.3-22b-dev-fp8.safetensors', 'ltx-2.3-22b-distilled-fp8.safetensors', 'stable_zero123.ckpt'] | _Omitted = ...,
    pass_raw: bool = ...,
    **_extras: Any,
) -> Any: ...
...
def OneShotInstructTokenize(
    *args: VibeWorkflow,
    ...
    model: Any | _Omitted = ...,
    prompt: str | _Omitted = ...,
    chat_template: Literal['default', 'alpaca', 'amberchat', 'chatml', 'chatqa', 'falcon-instruct', 'gemma-it', 'llama-2-chat', 'llama-3-instruct', 'llava-v1.6-mistral-7b-hf', 'mistral-instruct-v0.1', 'mistral-instruct', 'openchat', 'phi-3', 'saiga', 'solar-instruct', 'vicuna', 'zephyr'] | _Omitted = ...,
    images: Any | _Omitted = ...,
    videos: Any | _Omitted = ...,
    system_prompt: str | _Omitted = ...,
    pass_raw: bool = ...,
...
def TransformersImageProcessorLoader(
    *args: VibeWorkflow,
    _id: str | None = ...,
    ckpt_name: Literal['llava-hf/llava-v1.6-mistral-7b-hf', 'Qwen/Qwen2-VL-7B-Instruct', 'microsoft/Florence-2-large-ft', 'appmana/Cosmos-1.0-Prompt-Upsampler-12B-Text2World-hf', 'google/paligemma2-28b-pt-896', 'MiaoshouAI/Florence-2-base-PromptGen-v2.0', 'microsoft/Florence-2-base-ft', 'facebook/nllb-200-distilled-1.3B', 'llava-hf/llama3-llava-next-8b-hf', 'microsoft/Florence-2-base', 'THUDM/chatglm3-6b', 'ResembleAI/chatterbox', 'gokaygokay/Florence-2-SD3-Captioner', 'google/paligemma2-10b-pt-896', 'MiaoshouAI/Florence-2-large-PromptGen-v1.5', 'llava-hf/llava-onevision-qwen2-7b-si-hf', 'gokaygokay/Florence-2-Flux-Large', 'microsoft/Phi-4-mini-instruct', 'microsoft/Florence-2-large', 'roborovski/superprompt-v1', 'google/paligemma-3b-ft-refcoco-seg-896', 'thwri/CogFlorence-2.1-Large', 'thwri/CogFlorence-2.2-Large', 'MiaoshouAI/Florence-2-large-PromptGen-v2.0', 'JingyeChen22/textdiffuser2_layout_planner', 'ResembleAI/chatterbox-turbo', 'PromptEnhancer/PromptEnhancer-32B', 'JingyeChen22/textdiffuser2-full-ft', 'Yanrui95/NormalCrafter', 'microsoft/phi-4', 'MiaoshouAI/Florence-2-base-PromptGen-v1.5'] | _Omitted = ...,
...
def UpscaleModelLoader(
    *args: VibeWorkflow,
    _id: str | None = ...,
    model_name: Literal['4xNomos8k_atd_jpg.pth', 'RealESRGAN_x4plus.pth', 'RealESRGAN_x4plus.safetensors'] | _Omitted = ...,
    pass_raw: bool = ...,
    **_extras: Any,
) -> Any: ...
