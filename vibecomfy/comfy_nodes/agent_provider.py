...
def build_batch_messages(
    *,
    ...
    system = (
        ...
        "Search first:\n"
        "Only signatures for nodes already in the graph are shown.\n"
        "Call `search()` for any other type before constructing it.\n"
        "The available node type names list tells you what to search for.\n\n"
        "Placement:\n"
        ...
        "Worked example:\n"
        "Add 2x upscale after video decode, feed to existing saver:\n"
        "```batch\n"
