...
_EXPORT_MODULES = {
    ...
    "build_reverse_map": "vibecomfy.porting.identity.codec",
    ...
    "encode_slot_names": "vibecomfy.porting.identity.codec",
    ...
    "slot_codec": "vibecomfy.porting.identity.codec",
    "StatementResult": "vibecomfy.porting.edit.session",
    "to_python_identifier": "vibecomfy.porting.identity.codec",
    "to_raw_name": "vibecomfy.porting.identity.codec",
