...
from megaplan._core.canonical import canonical_projection_bytes, sha256_hex, sha256_uri
from megaplan._pipeline.behavioral_manifest import capsule_definition_identity_projection
from megaplan._pipeline.contracts import is_legal_coercion
