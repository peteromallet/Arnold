...
```bash
PYENV_VERSION=3.11.11 python -m megaplan bakeoff run \
...
```bash
PYENV_VERSION=3.11.11 python -m megaplan bakeoff compare --exp <id>  # required before pick
PYENV_VERSION=3.11.11 python -m megaplan bakeoff pick --exp <id> --profile <winner> --rationale "..."
PYENV_VERSION=3.11.11 python -m megaplan bakeoff merge --exp <id>
```
