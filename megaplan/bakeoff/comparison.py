...
from megaplan.bakeoff.judge import JudgeVerdict
from megaplan.bakeoff.state import BakeoffState, bakeoff_root
...
def build_comparison(
    ...
    return {
        ...
        "profiles": [
            _comparison_profile(record, profile_metrics.get(record["name"], {}))
...
def _comparison_profile(record: dict[str, Any], metrics_result: dict[str, Any]) -> dict[str, Any]:
    return {
