...
def _swap_premium_spec(spec: str, target_vendor: str) -> str:
    ...
    # Model pinned → map by capability tier where a cross-vendor equivalent
    # exists (claude sonnet/opus → codex effort), else refuse.
    if parsed.agent == "claude" and target_vendor == "codex":
