...
from megaplan.workers.shannon_session import (
    Turn,
    _seeded_rng_for_run,
...
def run_shannon_stream_step(
    ...
    *,
    ...
    from megaplan.workers.shannon import _append_json_output_contract
    ...
    payload = _normalize_worker_payload(step, result.payload)
    try:
