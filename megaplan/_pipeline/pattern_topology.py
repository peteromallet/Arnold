...
This module has moved to :mod:`arnold.pipeline.pattern_topology`.
...
warnings.warn(
    "megaplan._pipeline.pattern_topology is deprecated; "
    "use arnold.pipeline.pattern_topology instead.",
    DeprecationWarning,
    stacklevel=2,
)

from arnold.pipeline.pattern_topology import *  # noqa: F403, E402
