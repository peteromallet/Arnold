...
_GLOBAL_TARGETS = [
    {
        "agent": "claude",
        "detect": ".claude",
        "path": ".claude/skills/megaplan/SKILL.md",
    ...
    },
    {
        "agent": "codex",
        "detect": ".codex",
        "path": ".codex/skills/megaplan/SKILL.md",
        "data": "_composed/codex_skill.md",
        "install": "symlink",
    },
    {
        "agent": "cursor",
        "detect": ".cursor",
        "path": ".cursor/rules/megaplan.mdc",
        "data": "_composed/cursor_rule.mdc",
        "install": "symlink",
    },
    {
        "agent": "claude",
        "detect": ".claude",
        "path": ".claude/skills/megaplan-tickets/SKILL.md",
    ...
    },
    {
        "agent": "codex",
        "detect": ".codex",
        "path": ".codex/skills/megaplan-tickets/SKILL.md",
        "data": "tickets_skill.md",
        "install": "symlink",
    },
    {
        "agent": "claude",
        "detect": ".claude",
        "path": ".claude/skills/megaplan-decision/SKILL.md",
        "data": "decision_skill.md",
        "install": "symlink",
    },
    {
        "agent": "codex",
        "detect": ".codex",
        "path": ".codex/skills/megaplan-decision/SKILL.md",
        "data": "decision_skill.md",
        "install": "symlink",
    },
    {
        "agent": "claude",
        "detect": ".claude",
        "path": ".claude/skills/megaplan-epic/SKILL.md",
        "data": "epic_skill.md",
        "install": "symlink",
    },
    {
        "agent": "codex",
        "detect": ".codex",
        "path": ".codex/skills/megaplan-epic/SKILL.md",
        "data": "epic_skill.md",
        "install": "symlink",
    },
    {
        "agent": "claude",
        "detect": ".claude",
        "path": ".claude/skills/megaplan-observe/SKILL.md",
    ...
    },
    {
        "agent": "codex",
        "detect": ".codex",
        "path": ".codex/skills/megaplan-observe/SKILL.md",
        "data": "observe_skill.md",
        "install": "symlink",
    },
]
...
def handle_user_action(root: Path, args: argparse.Namespace) -> StepResponse:
    ...
    tasks_arg: str | None = getattr(args, "tasks", None)
    task_list: list[str] | None = None
    selected_scope = build_prerequisite_scopes(finalize_data).get(action_id)
    if tasks_arg:
        task_list = [t.strip() for t in tasks_arg.split(",") if t.strip()]
