...
from megaplan.cloud.providers.base import DeployReport, DeployStepReport, _write_redacted_output, get_provider
from megaplan.cloud.redact import redact
...
def _register_cloud_subcommands(cloud_parser: argparse.ArgumentParser) -> None:
    ...
    chain_parser.add_argument(
        ...
        action="store_true",
        help=(
            "Pass --no-git-refresh to the remote `megaplan chain start`, "
            "skipping the automatic base-branch checkout and pull."
        ),
    )
...
def _deploy_report_payload(
    ...
    *,
    ...
    return {
        ...
        "note": (
            "cloud deploy updates the thin runner service. Routine megaplan behavior "
