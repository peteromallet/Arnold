...
For LTX-specific source coverage and the Discord-derived approach matrix, see `docs/ltx_workflow_coverage.md`.

For cross-cutting template/converter/runtime issues, see `docs/structural_issues.md`.
