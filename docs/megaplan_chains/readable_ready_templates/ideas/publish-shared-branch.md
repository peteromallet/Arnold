...
- Work only on `megaplan/production-parity-templates`.
...
4. Push to `origin megaplan/production-parity-templates`.
5. Report the pushed commit SHA and any validation gaps.

## Success Criteria

- Exactly one branch is pushed: `megaplan/production-parity-templates`.
