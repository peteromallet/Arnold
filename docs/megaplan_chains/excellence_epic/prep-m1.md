...
| `tools/check_canonical_parity.py` | ❌ Does not exist on this branch | Referenced in `docs/decorator_template_emitter_completion.md` line 266 (noted as feature-branch-only) |
