...
|---|--------|------|--------|-------------|
| L1 | `e752578` (node-resolution wt) | known_failures.txt allowlist for talking_avatar + `../structural_issues.md` root-cause note | low | cherry-pick; may touch known_failures.txt also touched by cleanup |
