...
| `scripts/backfill_step_receipts.py` | archive | Move to `docs/archive/m5/scripts/`. | delete |
| `scripts/megaplan_live_watchdog.py` | migrate | Update to call new live-supervisor workflow runtime. | keep |
| `scripts/m4_oracle_bisect.py` | archive | Move to `docs/archive/m5/scripts/`. | delete |
| `scripts/record_oracle_traces.py` | archive | Move to `docs/archive/m5/scripts/`. | delete |
...
| `scripts/silent_failure_census.py` | archive | Move to `docs/archive/m5/scripts/`. | delete |

## `tools/`

| Tool | Status | Final location / action | M6 disposition |
| --- | --- | --- | --- |
| `tools/m4_oracle_bisect.py` | archive | Move to `docs/archive/m5/tools/`. | delete |

## Root helpers

| Helper | Status | Final location / action | M6 disposition |
| --- | --- | --- | --- |
| `_gen_corpus.py` | archive | Move to `docs/archive/m5/`. | delete |
| `_gen_golden_traces.py` | archive | Move to `docs/archive/m5/`. | delete |
