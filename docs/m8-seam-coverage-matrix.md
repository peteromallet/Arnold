...
| Capability alias normalization | `arnold/pipeline/costing/model_resource_capabilities.py:1` | Maps author-facing `requires-vision-model` and `requires-image-decoder` aliases into the closed runtime capability vocabulary |
