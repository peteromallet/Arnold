...
- [GraphBuilder spike](graphbuilder_spike.md)
- [Old VibeComfy port rationale](old_vibecomfy_port_rationale.md)
- [Sprint 5 follow-ups](sprint5_followups.md)
- [Template cleanup follow-ups](template_cleanup_followups.md)
