...
if __name__ == "__main__":
    ...
    if not key:
        ...
        print()
        print("In Arnold/omp (via prefix like claude: or omp:provider/model):")
        print("  omp:xai/grok-4.5   or   --phase-model foo=omp:xai/grok-4.5")
        print("  (XAI_API_KEY added to .env + ~/.omp/.env)")
