...
Briefs live as committed files under `.megaplan/initiatives/`. Single-plan ideas live
at `.megaplan/initiatives/{slug}.md`; epics live at
`.megaplan/initiatives/{epic-slug}/chain.yaml` with milestone briefs beside the chain
...
not move arbitrary files into `.megaplan/initiatives/`. If the idea file is a markdown
