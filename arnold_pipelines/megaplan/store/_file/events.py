...
from arnold_pipelines.megaplan._core.io import read_committed_framed_json_records
from arnold_pipelines.megaplan.schemas import EpicEvent
from arnold_pipelines.megaplan.schemas.base import utc_now
from arnold_pipelines.megaplan.store.base import StoredEvent
    ...
    def record_epic_event(
        ...
        *,
        ...
        if (
            ...
            from arnold_pipelines.megaplan.tickets import address_resolved_by_epic
