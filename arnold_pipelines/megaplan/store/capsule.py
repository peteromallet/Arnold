...
from arnold_pipelines.megaplan._pipeline.behavioral_manifest import capsule_definition_identity_projection
from arnold_pipelines.megaplan._pipeline.contracts import is_legal_coercion
