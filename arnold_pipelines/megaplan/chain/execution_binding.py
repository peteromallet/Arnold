...
def _future_source_reconciliation_is_safe(
    *,
    ...
    """Classify changes confined to unmaterialized milestone briefs."""
    ...
    if not isinstance(revision, Mapping) or not revision.get("ok"):
        # An explicit pending source requirement can still hold the boundary
        # closed until a new authoritative revision is installed.
