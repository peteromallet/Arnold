...
def _resolve_run_id() -> Optional[str]:
    try:
        from arnold_pipelines.megaplan.observability.events import _resolve_run_id as _r
        return _r()
    except Exception:
        return None
...
def _journal_intent(
    ...
    *,
    ...
    if store is not None:
        try:
            from arnold_pipelines.megaplan.observability.event_sink import StoreBackend
