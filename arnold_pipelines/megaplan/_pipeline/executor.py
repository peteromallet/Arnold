...
from arnold_pipelines.megaplan._pipeline.envelope import EMPTY_ENVELOPE, EnvelopeDroppedError, RunEnvelope
...
def _assert_envelope_present(envelope: "RunEnvelope | None", context: str) -> None:
    ...
    """
    from arnold_pipelines.megaplan._pipeline.flags import conveyance_strict_on
...
def _legacy_awaiting_user_contract(
    *,
    ...
    from arnold_pipelines.megaplan._pipeline.resume import check_awaiting_user
...
def _run_parallel_stage(node: ParallelStage, ctx: StepContext) -> StepResult:
    ...
    * Results are collected in declaration order (not completion order)
    ...
    try:
        from arnold_pipelines.megaplan.runtime.governor import current_governor as _cur_gov
        _gov_p = _cur_gov()
        ...
        from arnold_pipelines.megaplan.runtime.governor import BudgetExceeded as _BE
        import sys as _sys
...
def run_pipeline(
    ...
    *,
    ...
    from arnold_pipelines.megaplan._pipeline.flags import unified_dispatch_on as _udo
    if _udo():
        from arnold_pipelines.megaplan.runtime import install_runtime_governor as _install_gov
    ...
    while True:
        ...
        from arnold_pipelines.megaplan.observability.events import emit as _emit_event, EventKind as _EK
        ...
        try:
            ...
            from arnold_pipelines.megaplan.runtime.governor import current_governor as _current_gov
            _gov = _current_gov()
            if _gov is not None:
        ...
        from arnold_pipelines.megaplan.runtime.governor import current_governor as _cur_gov_seq
        _gov_s = _cur_gov_seq()
        ...
        from arnold_pipelines.megaplan._pipeline.flags import unified_evaluand_on
        if unified_evaluand_on():
            from arnold_pipelines.megaplan.observability.evaluand import _evaluand_transaction_boundary
...
def run_pipeline_with_policy(
    ...
    *,
    ...
    from arnold_pipelines.megaplan._pipeline.runtime import RuntimePolicy as _Policy
