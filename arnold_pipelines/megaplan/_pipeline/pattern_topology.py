...
from arnold_pipelines.megaplan._pipeline._forward_m2_m3 import restore_and_diverge  # TODO(M3): sentinel → RoutingKey
from arnold_pipelines.megaplan._pipeline.pattern_types import PromoteFn
...
def critique_revise_gate_loop(
    ...
    *on_iterate* / *on_proceed* / *on_tiebreaker* / *on_escalate*, plus
    ...
    # from arnold_pipelines.megaplan._pipeline.patterns).
    from arnold_pipelines.megaplan.routing import critique_revise_gate_routing as _routing
...
def iterate_until(
    ...
    *condition* and *max_iterations* document the contract; the wrapped
    ...
    from arnold_pipelines.megaplan._pipeline.loop_node import LoopNode
...
def escalate_if(
    ...
    *condition* documents when the host Step should emit a
    ...
    from arnold_pipelines.megaplan.routing import PLAN_ESCALATE as _ESC
