...
from arnold_pipelines.megaplan._pipeline.envelope import EMPTY_ENVELOPE, RunEnvelope
...
class Pipeline:
    ...
    def builder(
        ...
        *,
        ...
        from arnold_pipelines.megaplan._pipeline.builder import PipelineBuilder
        ...
        *,
        ...
        try:
            if phase == "feedback" and phase not in self.stages:
                from arnold_pipelines.megaplan.cli.feedback import handle_feedback
