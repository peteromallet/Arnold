...
def _run_pipeline(args: argparse.Namespace) -> int:
    ...
    if (
        ...
        if isinstance(artifact_stage, str) and artifact_stage:
            from arnold_pipelines.megaplan._pipeline.step_helpers import latest_artifact
...
def _resolve_profile_for_run(
    *,
    ...
    from arnold_pipelines.megaplan._pipeline.registry import canonical_pipeline_name
