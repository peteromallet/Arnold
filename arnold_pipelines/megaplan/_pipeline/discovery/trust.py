...
# legacy imports (``from arnold_pipelines.megaplan._pipeline.discovery.trust import
# KNOWN_CAPABILITIES``) continue to work.
from arnold_pipelines.megaplan._pipeline.discovery import (  # noqa: E402, F401
    KNOWN_CAPABILITIES,
    check_capabilities,
)
