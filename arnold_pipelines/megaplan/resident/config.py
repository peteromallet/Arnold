...
class ResidentConfig(BaseModel):
    ...
    def from_env(cls, environ: dict[str, str] | None = None) -> "ResidentConfig":
        ...
        return cls(
            ...
            model_timeout_s=_env_optional_float(env, "MEGAPLAN_RESIDENT_MODEL_TIMEOUT_S"),
            ...
            special_requests_subagent_timeout_s=_env_optional_float(
                env, "MEGAPLAN_RESIDENT_SPECIAL_REQUESTS_SUBAGENT_TIMEOUT_S"
            ),
