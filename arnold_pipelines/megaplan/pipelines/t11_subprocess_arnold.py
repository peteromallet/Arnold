"""Native-first projected shell for the ``t11-subprocess-arnold`` pipeline."""
...
_PIPELINE_DIR: Path = Path(__file__).parent / "t11-subprocess-arnold"

name: str = "t11-subprocess-arnold"
...
@pipeline("t11-subprocess-arnold")
def t11_subprocess_arnold_native(ctx: object) -> Any:
...
def _native_program() -> Any:
    return compile_pipeline(t11_subprocess_arnold_native)


def build_pipeline() -> Pipeline:
    """Return the canonical native-backed ``t11-subprocess-arnold`` :class:`Pipeline`."""
