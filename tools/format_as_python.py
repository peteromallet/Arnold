...
def format_as_python(
    ...
    *,
    ...
    out_lines.append("")
    out_lines.append("")
    out_lines.append(_format_metadata_dict("READY_METADATA", ready_metadata))
    out_lines.append("")
    out_lines.append(_format_metadata_dict("READY_REQUIREMENTS", ready_requirements))
    out_lines.append("")
    out_lines.append("")
    ...
    sorted_ids = _topological_node_order(workflow_nodes, edges_in)
